    ...
    <div class="max-w-xl">
      ...
      >
        ...
        <span
          ...
          >free</span
        >
        <span> way to match car owners and auto shops</span>
      </div>
...
<div class=" flex flex-col items-center text-center">
  <h3 class="font-bold m-3 w-full content-center">
    Keep up to date by subscribing to our email newsletter
  </h3>
  <form method="post" class="form-control w-full max-w-lg m-5" use:enhance>
  ...
  {#if form?.success}
    ...
    <p class="m-4 font-bold">Successfully Subscribed!</p>
  {/if}
</div>
